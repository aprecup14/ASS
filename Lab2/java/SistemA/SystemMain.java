...
public class SystemMain {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Rolurile pentru a scrie si citi studentii acceptati folosind formatarea specifica.
            ...
            MergeFilter filterMergeAccepted
                = new MergeFilter("Accepted", roleISAcceptedSync, roleNonISAcceptedSync, roleAcceptedSource);
            MergeFilter filterMergeRejected = new MergeFilter("Rejected", roleISRejectedSync, roleNonISRejectedSync, roleRejectedOutputFileSource);
            OutputFormatterFilter outputWithNameSpecializationFormatFilter = new OutputFormatterFilter("Format nume specializare", roleAcceptedSync, roleOutputFileSource, s -> String.format("%s %s", s.sName, s.sProgram));
            ...
            while (roleInputFileSync.ready() || filterSplitIS.busy()
                    ...
                    || filterMergeAccepted.busy() || filterMergeRejected.busy() || outputWithNameSpecializationFormatFilter.busy()) {
